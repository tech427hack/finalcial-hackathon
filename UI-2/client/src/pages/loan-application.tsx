...
const step2Schema = z.object({
  ...
  tenureMonths: z.string().min(1, "Loan tenure is required"),
...
export default function LoanApplication() {
  ...
  const handleStep2Submit = (data: Step2Data) => {
    ...
    const loanApplication = {
	  ...
	  monthlyEmi: calculateEMI(amount, tenureMonths)
    };
  ...
  const calculateEMI = (amount: number, tenureMonths: number) => {
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t('form.loanTenureMonths')} *</FormLabel>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                {tenureMonthsOptions.map((option) => (
                    ...
                    {step2Form.watch('amount') && step2Form.watch('tenureMonths') && (
                      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        ...
                        <p className="text-blue-700 dark:text-blue-200 text-sm">
                          Estimated Monthly EMI: ₹{calculateEMI(
                            ...
                            parseInt(step2Form.watch('tenureMonths')) || 12
                          ).toLocaleString()}
                        </p>
                      </div>
                    )}
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-medium">{step2Form.getValues('tenureMonths')} months</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Monthly EMI:</span>
                      <span className="ml-2 font-medium">₹{calculateEMI(
                        parseFloat(step2Form.getValues('amount')), 
                        parseInt(step2Form.getValues('tenureMonths'))
                      ).toLocaleString()}</span>
                    </div>
                  </div>
                </div>
